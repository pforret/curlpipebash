...
## Description
* run `curl -s https://php.new/install/mac/8.4 | bash` to install PHP, Composer and Laravel
* cf [https://php.new/](https://php.new/) 
...
box() {
  ...
  if [ "$PATH_UPDATED" = true ]; then
    local profile_content="Please restart your terminal or run \e[1m'source $PROFILE_FILE'\e[0m to update 
your PATH."
  fi

  # Top of the box with the message, using light gray color
  printf "${light_gray}┌ ${reset}\033[42m\e[1m\033[30m${msg}\e[0m${reset} ${light_gray}$(printf '─%.0s' 
$(seq 1 $filler))${reset}\n"
...
box "Success!" "\e[1mphp\e[0m, \e[1mcomposer\e[0m, and \e[1mlaravel\e[0m have been installed successfully." 
"For a \e[1mfully-featured dev environment\e[0m for PHP, check out" "Laravel Herd. 
\e[4m\e[34mhttps://herd.laravel.com"```
