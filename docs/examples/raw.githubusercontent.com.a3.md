...
## Description
* run `curl -s https://raw.githubusercontent.com/Homebrew/install/HEAD/install.sh | bash` to install homebrew, MacOS package manager
* cf [https://brew.sh/](https://brew.sh/) 
