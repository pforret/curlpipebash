...
## Description
* run `curl -s https://raw.githubusercontent.com/nvm-sh/nvm/v0.40.1/install.sh | bash` to install nvm Node Version Manager
* cf [https://github.com/nvm-sh/nvm](https://github.com/nvm-sh/nvm) 
