...
## Description
* run `curl -s https://raw.githubusercontent.com/basherpm/basher/master/install.sh | bash` to install basher, bash package manager
* cf [https://www.basher.it/](https://www.basher.it/) 
