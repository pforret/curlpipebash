...
The full script source is saved as [`docs/scripts/raw_githubusercontent_com_basherpm_basher_master_install_sh.txt`](../docs/scripts/raw_githubusercontent_com_basherpm_basher_master_install_sh.txt).
